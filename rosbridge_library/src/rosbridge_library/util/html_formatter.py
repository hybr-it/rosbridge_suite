...
"""
    ...
    Customized Formatter for HTML output.
    Modified code from pygments html.py
...
class HtmlFormatter(Formatter):
    ...
    **Subclassing the HTML formatter**
    ...
    def format_parts(self, ttype, value, parts):
        """Format token (ttype, value) and its escaped representation in parts,
    ...
    def _format_lines(self, tokensource):
        ...
        for ttype, value in tokensource:
            ...
            parts = self.format_parts(ttype, value, parts)
